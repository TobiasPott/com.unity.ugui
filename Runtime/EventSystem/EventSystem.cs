...
namespace UnityEngine.EventSystems
{
    ...
    public class EventSystem : UIBehaviour
    {
        ...
        /// </summary>
        [Obsolete("The 'EventSystem.current' static property is no longer supported with the multiple concurrent event system version. Please check whether accessing it is actually required and make sure it works as expected.")]
